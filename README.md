# Deutscher Bundestag DIP (deutscher-bundestag-dip)
...
## API
- **Deutscher Bundestag DIP** — [Documentation](https://dip.bundestag.de/documents/informationsblatt_zur_dip_api_v01.pdf)
